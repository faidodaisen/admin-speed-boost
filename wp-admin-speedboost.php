 ...
 * Description:       Modular WordPress admin performance booster. 15 toggle-able modules: heartbeat throttle, dashboard widget cleanup, disable comments, REST lockdown, emoji/oEmbed disable, jQuery Migrate kill, classic editor, XML-RPC disable, hide login URL, and more. Plus one-click DB cleanup.
 * Version:           1.3.0
